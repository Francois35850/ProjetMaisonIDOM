...
public class Main {
	...
	private static DetecteurOuverture detecteur_ouverture_bureau = new DetecteurOuverture("Détecteur ouverture bureau", false, bureau);
	private static DetecteurOuverture detecteur_ouverture_salon1 = new DetecteurOuverture("Détecteur ouverture salon fenêtre sud", false, salon); 	
	private static DetecteurOuverture detecteur_ouverture_salon2 = new DetecteurOuverture("Détecteur ouverture salon fenêtre est", false, salon);
	private static DetecteurOuverture detecteur_ouverture_ch1 = new DetecteurOuverture("Détecteur ouverture chambre David", false, chambre1);
	private static DetecteurOuverture detecteur_ouverture_ch2 = new DetecteurOuverture("Détecteur ouverture chambre Régine", false, chambre2);
	private static DetecteurOuverture detecteur_ouverture_chp = new DetecteurOuverture("Détecteur ouverture chambre parentale", false,, chambre1));
	private static DetecteurOuverture detecteur_ouverture_sallejeux = new DetecteurOuverturee("Détecteur ouverture salle de jeux", false, chambre_parentale);
	private static DetecteurOuverture detecteur_ouverture_studio = new DetecteurOuverture("Détecteur ouverture studio", false, studio);
	private static DetecteurOuverture detecteur_ouverture_cuisine = new DetecteurOuverture("Détecteur ouverture cuisine", false, cuisine);
	private static DetecteurOuverture detecteur_ouverture_sallemanger = new DetecteurOuverture("Détecteur ouverture salle � manger", false, salle_a_manger);
