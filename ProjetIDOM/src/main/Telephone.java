	...
	public static void Messages(int choix, ITelephone iphone) {
		if (choix == 1) {
			...
			case "MA PETITE FEMME" :
				System.out.println("Ma petite femme - 20/05/2020 - 16h23 :\n Il faudrait aller chercher les petites voitures qu'il y a chez mes parents pour les donner au voisin. Si t'as le temps d'y passer �a serait super. Bisous chérie <3");
				break;
